...
class TestSignUpView(TestCase):
    ...
    def test_sign_up_successful_return_201(self):
        username = "keyvan"
        password = "123456"
        response = self.client.post("/accounts/signup", data={"username": username, "password": password},
    ...
    def test_sign_up_duplicated_username_return_403(self):
        username = "keyvan"
        password = "123456"
        self.client.post("/accounts/signup", data={"username": username, "password": password}, content_type="application/json")
        duplicated_username = "keyvan"
        response = self.client.post("/accounts/signup", data={"username": duplicated_username, "password": password},
                                    content_type="application/json")
